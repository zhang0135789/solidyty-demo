...
module.exports = {
  ...
  newCustomer: function (ScoreInstance, account) {
    ...
    ScoreInstance.newCustomer(address, password, { from: account, gas: 3000000 }).then(function (r ,e) {
      // ScoreInstance.NewCustomer(
      //     function (e, r) {
        if (!e) {
  ...
  transferScoreToAnotherFromCustomer: function (currentAccount, ScoreInstance, account) {
    ...
    ScoreInstance.transferScoreToAnother(0, currentAccount, receivedAddr, amount, { from: account }).then(function(r, e){
      if (!e) {
        console.log(r.logs[0].args)
  ...
  buyGood: function (currentAccount, ScoreInstance, account) {
    ...
    ScoreInstance.buyGood(currentAccount, goodId, { from: account, gas: 1000000 }).then(function (r,error) {
