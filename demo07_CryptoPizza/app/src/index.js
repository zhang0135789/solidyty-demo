...
//导入合约文件
import CryptoPizza from '../../build/contracts/CryptoPizza.json'
// import "./index.css"

// import { default as contract } from 'truffle-contract'
// var _contract = contract(CryptoPizza);
...
Contracts['CryptoPizza'] = {
 ...
 abi: [CryptoPizza],
  //合约地址
 address: "0xC636aE1Fe5f331dB7236e40c665d8163281D0fc4",
  //节点地址
...
Pizza.prototype.init = function()  {
  ...
  this.web3 && console.log("wen3 已经加载");
  ...
  this.instance = this.Contract.address
      ...
      : { getPizzasByOwner: () => {} };
  //部署合约
  this.instance && console.log("合约已经部署")
...
Pizza.prototype.loadInventory = function() {
  ...
  // this.instance.getPizzasByOwner(accounts, function(
  //     error,
  //     pizzaIds
  // ) {
  //   if (error) {
...
console.log(typeof Contracts === "undefined" , "初始化合约结果");
if (typeof Contracts === "undefined")
  Contracts = { CryptoPizza: { abi: [] } };
